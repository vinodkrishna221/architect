        ...
        <header className="fixed top-0 left-0 right-0 h-16 z-50 flex items-center justify-between px-6 border-b border-white/5 bg-black/50 backdrop-blur-xl">
            ...
            <div className="flex items-center gap-2">
                <MagneticButton>
                    <span
                        ...
                        className="font-mono font-bold tracking-tighter text-white text-lg hover:text-white/80 transition-colors cursor-pointer"
                    >
                        THE_ARCHITECT
                    </span>
                </MagneticButton>
            ...
            <div className="flex items-center gap-4">
                ...
                <MagneticButton
                    ...
                    className="w-8 h-8 rounded-full bg-zinc-800 border border-white/10 flex items-center justify-center hover:bg-zinc-700 transition-colors cursor-pointer"
                >
